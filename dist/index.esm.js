...
var InitialsWrapper = styled.span(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  color: ", ";\n  font-family: ", ";\n  font-weight: ", ";\n  letter-spacing: 1.25px;\n  transform: translateX(1px);\n"])), function (p) {
...
var Wrapper$1 = styled(function (_ref) {
  _ref.picture;
      _ref.height;
      _ref.width;
      _ref.withInitials;
...
var UserAvatar = function UserAvatar(props) {
  ...
  var initials = useMemo(function () {
    ...
    if (!!(withInitials !== null && withInitials !== void 0 && (_withInitials$firstna = withInitials.firstname) !== null && _withInitials$firstna !== void 0 && _withInitials$firstna.length)) {
      return typography$1.getNameInitials(withInitials.firstname, withInitials === null || withInitials === void 0 ? void 0 : withInitials.lastname);
    }
...
UserAvatar.propTypes = {
  ...
  withInitials: PropTypes.oneOfType([PropTypes.shape({
...
var LabelWrapper = styled(function (_ref) {
  _ref.noMargin;
      _ref.required;
...
var Count = styled.p(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  color: ", ";;\n  display: flex;\n  font-size: ", ";\n  justify-content: flex-end;\n  margin: 0 0 0 auto;\n"])), function (p) {
  return p.theme.colors.textPrimary;
}, function (p) {
  return p.theme.typography.sizes.small;
});
var ErrorMessage = styled.p(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n  align-items: center;\n  color: ", ";\n  display: flex;\n  font-size: ", ";\n  margin-top: 5px;\n  svg {\n    margin-right: 5px;\n    path:not(:first-child) {\n      fill: ", ";\n    }\n  }\n"])), function (p) {
...
var CountWrapper = styled.div(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["\n  display:flex;\n  ", " {\n    flex: 1;\n    padding-right: 20px;\n  }\n  ", " {\n    box-sizing: border-box;\n    margin-top: 5px;\n  }\n"])), ErrorMessage, Count);
...
Textarea.propTypes = {
  ...
  onChange: PropTypes.oneOfType([PropTypes.func, PropTypes.number // used for null
  ]),
  value: PropTypes.string.isRequired,
  error: PropTypes.oneOfType([PropTypes.string, PropTypes.number // used for null
  ]),
  maxLength: PropTypes.number,
  disabled: PropTypes.bool,
  required: PropTypes.bool,
  fullWidth: PropTypes.bool,
  placeholder: PropTypes.oneOfType([PropTypes.string, PropTypes.number // used for null
  ]),
...
var commonStyle = css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  align-items: center;\n  background-color: ", ";\n  border: none;\n  border-radius: ", "px;\n  box-sizing: border-box;\n  color: ", ";\n  cursor: ", ";\n  display: flex;\n  font-family: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  height: ", ";\n  justify-content: center;\n  letter-spacing: 0;\n  max-width: ", ";\n  outline: none;\n  padding: ", ";\n  width: ", ";\n  > svg {\n    margin-right: 7px;\n  }\n  &:hover {\n    ", ";\n  }\n  ", ";\n  ", ";\n"])), function (p) {
  ...
  var hoverBGColor = new TinyColor(p.theme.colors[p.schemes[p.scheme].backgroundColor]).darken(5);
...
var WrapperButton = styled(function (_ref) {
  _ref.size;
      _ref.label;
      _ref.onClick;
      _ref.fullWidth;
...
var WrapperLink = styled(function (_ref2) {
  _ref2.size;
      _ref2.label;
      _ref2.fullWidth;
      _ref2.bordered;
  ...
  return /*#__PURE__*/React.createElement(Link, rest);
})(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  ", ";\n  text-decoration: none;\n"])), commonStyle);
var WrapperOutsideLink = styled(function (_ref3) {
  _ref3.size;
      _ref3.label;
      _ref3.fullWidth;
      _ref3.bordered;
...
Button.propTypes = {
  ...
  title: PropTypes.oneOfType([PropTypes.string, PropTypes.number // used for null
  ]),
  onClick: PropTypes.oneOfType([PropTypes.func, PropTypes.number // used for null
  ]),
  fullWidth: PropTypes.bool,
  bordered: PropTypes.bool,
  to: PropTypes.oneOfType([PropTypes.string, PropTypes.number // used for null
  ]),
  icon: PropTypes.oneOfType([PropTypes.node, PropTypes.number // used for null
  ])
};

export { Button, FormLabel, Textarea, UserAvatar, theme };
